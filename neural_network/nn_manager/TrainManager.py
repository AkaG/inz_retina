...
class TrainManager(object):
    ...
    def default_callbacks(self, directory) -> List:
        return [
            ...
            callbacks.EarlyStopping(monitor='val_loss', min_delta=0.005, patience=5, verbose=0, mode='auto'),
            ModelSave(self.nn_save_class),
        ]

    def train_model(self, steps_per_epoch, validation_steps, epochs=5, save_at_end=True):
